...
var attrToProp = __webpack_require__(1)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hyperapp__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hyperapp___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__hyperapp__);
// region import
...
const anchor = n => __WEBPACK_IMPORTED_MODULE_0__hyperapp__["html"]`
	<h1>
		<a href=${"/" + n}>
			${n}
		</a>
...
const view = {
	...
	'/:key': (model, actions) => __WEBPACK_IMPORTED_MODULE_0__hyperapp__["html"]`
		<div>
...
const router = options => {
	...
	options.subscriptions.push((model, actions) => window.addEventListener('popstate', () => actions.setLocation(location.pathname)), (model, actions) => window.addEventListener('click', e => {
...
window.addEventListener('load', () => __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__hyperapp__["app"])(router({
	effects,
	model,
	subscriptions,
	update,
